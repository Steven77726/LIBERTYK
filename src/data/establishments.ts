...
const weddingEstablishments: LocalEstablishment[] = [{
  ...
  website: "https://www.google.com/search?sca_esv=1b85b69310503e88&sxsrf=APpeQnsOvxdev7phQ8H3vkU2NhyVwZ8ksQ:1787648744860&q=kinor+decor&source=lnms&fbs=ABfTbFUDadgeu2mn4mYJ8iEZ1GUDDuwRa4um-2LNhBFWIpqZc3x8792U5ZVg9NxUywAiNAAK9LTph7mlss0iXxz9ohv5X4K06bW0PTrZtlKhUziN3xNuDBluxKmAlxWKdwzlp51FGvsHCD0r8xIGZIwYbnp3xsaIfLAm8cNnOJDz24qChps0X6nUQI7A8UmrQxfSItuiqSmzkbh_lvaJyRrOoUDvQ6dnvQ&sa=X&ved=2ahUKEwipqa7DtruWAxVGOPsDHTXvFyAQ0pQJegQICxAB&biw=1578&bih=827&dpr=2",
  ...
  cuisineTypes: ["Décoration", "Scénographie", "Fleurs", "Houppa", "Mariage"],
  order: 1,
...
const sortiesEstablishments: LocalEstablishment[] = [
  {
    ...
    sponsorPriority: 0,
    sponsorDuration: "",
    cuisineTypes: ["Sorties", "Terrasse Festive", "Club", "Bar"],
    order: 1,
  ...
  },
  {
    ...
    sponsorPriority: 0,
    sponsorDuration: "",
    cuisineTypes: ["Soirées", "Célibataires", "Péniche", "Rencontres"],
    order: 2,
  ...
  },
  {
    ...
    sponsorPriority: 0,
    sponsorDuration: "",
    cuisineTypes: ["Restaurant Festif", "Dîner Musical", "Ambiance", "Sorties"],
    order: 3,
