  ...
  return (
    <footer className="mt-24 bg-ink text-white">
      <div className="page-shell grid gap-14 py-16 md:grid-cols-[1.5fr_1fr_1fr]">
        ...
        <div><p className="mb-4 text-xs uppercase tracking-[.18em] text-white/35">Liberty</p><div className="grid gap-2 text-sm text-white/65"><Link href="/mes-favoris">Mes Favoris</Link><Link href="/mon-compte">Mon compte</Link><Link href="/admin">Administration</Link><div className="mt-4 flex gap-2"><span className="grid size-9 place-items-center rounded-full bg-white/10"><Instagram size={16} /></span><span className="grid size-9 place-items-center rounded-full bg-white/10"><Linkedin size={16} /></span></div></div></div>
      </div>
