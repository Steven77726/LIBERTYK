  ...
  return (
    <EntityDrawer open={open} onClose={onClose} title={establishment.name}>
      <div className="space-y-5 p-6">
        ...
        {/* Badge discret Google Business & Avis vérifiés */}
        <div className="flex items-center justify-between rounded-2xl border border-black/5 bg-white/90 p-3 shadow-sm backdrop-blur">
          <div className="flex items-center gap-2.5">
            <div className="grid size-8 shrink-0 place-items-center rounded-xl border border-black/5 bg-white shadow-xs">
            ...
            <div>
              <div className="flex items-center gap-1.5 text-xs font-bold text-ink">
                ...
                <span className="font-normal text-ink/40">({googleData.userRatingsTotal} avis Google)</span>
              </div>
              <p className="text-[10px] font-medium text-emerald-700">Fiche vérifiée Google Business</p>
            </div>
          </div>
          <a
            ...
            className="flex items-center gap-1 rounded-xl bg-cream px-3 py-1.5 text-[11px] font-semibold text-ink/75 transition hover:bg-black/5"
          >
        ...
        {visibility.opening_hours !== false && hours.length > 0 && (
          <div>
            <p className="text-xs font-semibold uppercase tracking-[.14em] text-ink/35">Horaires Google en direct</p>
