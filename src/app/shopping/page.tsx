...
export default function ShoppingPage() {
  return (
    <>
      ...
      <section className="page-shell py-16 sm:py-24"><p className="eyebrow">Explorer</p><h2 className="section-title">Tous les univers shopping</h2><CardSubrubricGrid rubricSlug="shopping" fallbackCards={sections.map(({ title, description, href, image }) => ({ label: title, description, href, image }))} /></section>
    </>
  );
}
