...
const specificFoodEstablishments: LocalEstablishment[] = [
  {
    ...
    sponsorPriority: 1,
    sponsorDuration: "",
    cuisineTypes: ["Pâtisserie", "Trompe l'œil", "Salon de thé", "Gâteaux", "Café"],
    order: 1,
...
const beautyEstablishments: LocalEstablishment[] = [
  {
    ...
    sponsorPriority: 0,
    sponsorDuration: "",
    cuisineTypes: ["Coiffure", "Maquillage", "Lissage", "Mariage"],
    order: 1,
...
const salleEstablishments: LocalEstablishment[] = [
  {
    ...
    sponsorPriority: 0,
    sponsorDuration: "",
    cuisineTypes: ["Location de Salle", "Salle de réception", "Événementiel", "Mariage"],
    order: 1,
