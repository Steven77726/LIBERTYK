...
import { Activity, ArrowUpRight, Bell, CheckCircle2, Clock3, LayoutDashboard, Search, Settings, Store, UsersRound } from "lucide-react";

export const metadata: Metadata = { title: "Administration" };

const stats = [
  { label: "Établissements", value: "1 248", trend: "+12%", icon: Store },
  { label: "Membres", value: "8 642", trend: "+8%", icon: UsersRound },
  { label: "En attente", value: "24", trend: "À traiter", icon: Clock3 },
