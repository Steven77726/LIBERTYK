...
const shoppingEstablishments: LocalEstablishment[] = [
  {
    ...
    cuisineTypes: [],
    order: 1,
    customerSearches: ["azamra", "vêtement masculin", "homme", "mode", "costume", "chemise", "shopping", "boutique"],
    visibleTagIds: ["Vêtement masculin", "Homme", "Mode"],
  },
  {
    id: naor.slug,
    rubricId: "shopping",
    subrubricId: "vetement-feminin",
    mainPhoto: naor.image,
    photos: naor.photos,
    photoAlts: ["Naor Boutique", "Naor Collection 1"],
    name: naor.name,
    slug: naor.slug,
    shortDescription: `${naor.type} · Shopping`,
    description: naor.description,
    address: naor.address,
    city: naor.city,
    arrondissement: naor.arrondissement,
    postalCode: naor.postalCode,
    country: naor.country,
    nearestMetroName: naor.nearestMetroName,
    nearestMetroLine: naor.nearestMetroLine,
    email: "contact@naorparis.com",
    phone: naor.phone,
    whatsapp: naor.whatsapp,
    instagram: naor.instagram,
    website: naor.website,
    hours: naor.hours,
    terrace: false,
    delivery: false,
    takeaway: false,
    ...
    cuisineTypes: [],
    order: 2,
    customerSearches: ["naor", "vêtement féminin", "femme", "robe", "mode", "prêt-à-porter", "shopping", "boutique"],
    visibleTagIds: ["Vêtement féminin", "Femme", "Mode"],
  },
];
