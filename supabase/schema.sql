...
create table if not exists public.rubrics (
  ...
  display_format text not null default 'Carré standard',
  desktop_columns int not null default 3,
  tablet_columns int not null default 2,
  mobile_columns int not null default 1,
